...
**Related:** [SCENARIOS.md](SCENARIOS.md) (v0.14), [COMPACT.md](COMPACT.md) (v0.6.1), [REACH.md](REACH.md) (v0.1.4), [skills/homonoia-compact/SKILL.md](skills/homonoia-compact/SKILL.md) (v0.4.2)
...
- **v0.4.6 (2026-09-19):** Cross-reference only: header pointers updated for SCENARIOS.md v0.14 (the Trustee variant), COMPACT.md v0.6.1 (§6.7, no unreviewable power on either side), REACH.md v0.1.4 and the skill v0.4.2. Part of a synchronized pointer pass across all four documents. No change to the content or the argument.
