...
**Status:** [`SKILL.md`](SKILL.md) v0.5.1, fifth draft. Three result batches on two scenarios with one model family are in [`tests/results/`](../../tests/results/); no run has used v0.5 or later yet.
