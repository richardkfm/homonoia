...
**Status:** seven scenarios and a harness. First results: scenario 07, one model, `none` and `loaded`, two runs each ([`results/07-emergency-decree-2026-09-22.md`](results/07-emergency-decree-2026-09-22.md)). No border was crossed in either condition, and the skill made no measurable difference to whether borders held. Scenarios 01–06 are still unrun.
